...
public:
	...
	virtual void onSetup(SetupType type) = 0;
	virtual void onSwitch(uint32 type) = 0;
	virtual void onTimer(TimerId id) = 0;
	...
	virtual void onSound(Id id, SoundType type, uint32 a3, bool process) = 0;
	...
	virtual void onUpdateBefore(Id movabilityFrom, Id movabilityTo, uint32 movabilityIndex, Id target, const Common::Point &point) {}
	virtual void onBeforeRide(Id movabilityFrom, Id movabilityTo, uint32 movabilityIndex, Id target, MovabilityType movabilityType) = 0;
	virtual void onAfterRide(Id movabilityFrom, Id movabilityTo, uint32 movabilityIndex, Id target, MovabilityType movabilityType) = 0;
	virtual void onVisualList(Id id, uint32 type, const Common::Point &point) {}
};
