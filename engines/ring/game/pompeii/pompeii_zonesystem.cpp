...
void ZoneSystemPompeii::onInit() {
	...
	_app->objectAddPresentation(kObject4);
	_app->objectPresentationAddImageToPuzzle(kObject4, 1, kPuzzleMenu, "box_ok.bmp", Common::Point(240, 255), true, kDrawType1, 1000);
	_app->objectAddPresentation(kObject4);
	_app->objectPresentationAddImageToPuzzle(kObject4, 2, kPuzzleMenu, "box_cancel.bmp", Common::Point(360, 255), true, kDrawType1, 1000);
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(240, 255, 280, 295), false, kCursorMenuActive, 0);
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(360, 255, 400, 295), false, kCursorMenuActive, 1);
	...
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(240, 255, 280, 295), false, kCursorMenuActive, 4);
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(360, 255, 400, 295), false, kCursorMenuActive, 5);
	...
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(180, 250, 250, 281), false, kCursorMenuActive, 6);
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(180, 283, 250, 309), false, kCursorMenuActive, 7);
	...
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(240, 255, 280, 295), false, kCursorMenuActive, 8);
	_app->objectAddPuzzleAccessibility(kObject4, kPuzzleMenu, Common::Rect(360, 255, 400, 295), false, kCursorMenuActive, 9);
