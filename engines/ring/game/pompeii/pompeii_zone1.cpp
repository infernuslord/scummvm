...
void Zone1Pompeii::onInit() {
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1001, 0, kPuzzle1000, "s00a01n02p01s01", kImageTypeBMP, Common::Point(151, 34), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1001, 0, 0, 1001);
	_app->objectAddPresentation(kObject1001);
	_app->objectPresentationAddAnimationToPuzzle(kObject1001, 1, kPuzzle1000, "s00a01n02p01s02", kImageTypeBMP, Common::Point(219, 172), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1001, 1, 0, 1001);
	_app->objectAddPresentation(kObject1001);
	_app->objectPresentationAddAnimationToPuzzle(kObject1001, 2, kPuzzle1000, "s00a01n02p01s03", kImageTypeBMP, Common::Point(421, 44), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1001, 3, kPuzzle1001, "s00a01n02p02s01", kImageTypeBMP, Common::Point(59, 20), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1001, 3, 0, 1001);
	_app->objectAddPresentation(kObject1001);
	_app->objectPresentationAddAnimationToPuzzle(kObject1001, 4, kPuzzle1001, "s00a01n02p02s02", kImageTypeBMP, Common::Point(349, 16), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject10071);
	_app->objectPresentationAddAnimationToPuzzle(kObject10071, 1, kPuzzle1004, "s00a02n02p02s01", kImageTypeBMP, Common::Point(134, 35), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject10071, 1, 0, 1001);
	_app->objectAddPresentation(kObject10071);
	_app->objectPresentationAddAnimationToPuzzle(kObject10071, 2, kPuzzle1004, "s00a02n02p02s02", kImageTypeBMP, Common::Point(447, 141), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1009);
	_app->objectPresentationAddAnimationToPuzzle(kObject1009, 1, kPuzzle1007, "s00a02n02p04s01", kImageTypeBMP, Common::Point(471, 153), kDrawType1, 1000, 28, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1011);
	_app->objectPresentationAddAnimationToPuzzle(kObject1011, 1, kPuzzle1010, "s00a02n01p03s01", kImageTypeBMP, Common::Point(161, 43), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1011, 1, 0, 1001);
	_app->objectAddPresentation(kObject1011);
	_app->objectPresentationAddAnimationToPuzzle(kObject1011, 2, kPuzzle1010, "s00a02n01p03s02", kImageTypeBMP, Common::Point(340, 26), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1013);
	_app->objectPresentationAddAnimationToPuzzle(kObject1013, 1, kPuzzle1013, "s00a02n03p01s01", kImageTypeBMP, Common::Point(183, 55), kDrawType1, 1000, 15, 12.5f, 16);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1013, 1, 0, 1001);
	_app->objectAddPresentation(kObject1013);
	_app->objectPresentationAddAnimationToPuzzle(kObject1013, 2, kPuzzle1013, "s00a02n03p01s02", kImageTypeBMP, Common::Point(372, 133), kDrawType1, 1000, 15, 12.5f, 16);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1016, 0, kPuzzle1015, "s00a01n01p01s01", kImageTypeBMP, Common::Point(170, 191), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1016, 0, 0, 1001);
	_app->objectAddPresentation(kObject1016);
	_app->objectPresentationAddAnimationToPuzzle(kObject1016, 1, kPuzzle1015, "s00a01n01p01s02", kImageTypeBMP, Common::Point(324, 43), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1017);
	_app->objectPresentationAddAnimationToPuzzle(kObject1017, 1, kPuzzle1016, "s00a03n01p01s01", kImageTypeBMP, Common::Point(60, 185), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1019);
	_app->objectPresentationAddAnimationToPuzzle(kObject1019, 1, kPuzzle1017, "s00a03n02p01s01", kImageTypeBMP, Common::Point(217, 103), kDrawType1, 1000, 28, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1019, 1, 0, 1001);
	_app->objectAddPresentation(kObject1019);
	_app->objectPresentationAddAnimationToPuzzle(kObject1019, 2, kPuzzle1017, "s00a03n02p01s02", kImageTypeBMP, Common::Point(422, 90), kDrawType1, 1000, 28, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1020);
	_app->objectPresentationAddAnimationToPuzzle(kObject1020, 1, kPuzzle1020, "s00a01n08p01s01", kImageTypeBMP, Common::Point(140, 67), kDrawType1, 1000, 29, 12.5f, 16);
	...
	_app->objectAddPresentation(kObject1021);
	_app->objectPresentationAddAnimationToPuzzle(kObject1021, 2, kPuzzle1023, "s00a01n10p01s01", kImageTypeBMP, Common::Point(160, 85), kDrawType1, 1000, 30, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1023);
	_app->objectPresentationAddAnimationToPuzzle(kObject1023, 1, kPuzzle1026, "s00a02n04p01s01", kImageTypeBMP, Common::Point(165, 53), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1039, 0, kPuzzle1027, "s00a01n03p01s01", kImageTypeBMP, Common::Point(161, 224), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1039, 0, 0, 1001);
	_app->objectAddPresentation(kObject1039);
	_app->objectPresentationAddAnimationToPuzzle(kObject1039, 1, kPuzzle1027, "s00a01n03p01s02", kImageTypeBMP, Common::Point(366, 204), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1035, 0, kPuzzle1030, "s00a01n03p04s01", kImageTypeBMP, Common::Point(175, 45), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1041, 0, kPuzzle1033, "s00a01n03p07s01", kImageTypeBMP, Common::Point(221, 77), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1045, 0, kPuzzle1035, "s00a01n03p12s01", kImageTypeBMP, Common::Point(166, 35), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1028);
	_app->objectPresentationAddAnimationToPuzzle(kObject1028, 1, kPuzzle1007, "s00a02n02p04s01", kImageTypeBMP, Common::Point(471, 153), kDrawType1, 1000, 28, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1031);
	_app->objectPresentationAddAnimationToPuzzle(kObject1031, 1, kPuzzle1039, "s00a01n05p01s01", kImageTypeBMP, Common::Point(384, 177), kDrawType1, 1000, 29, 12.5f, 16);
	...
	_app->objectAddPresentation(kObject1033);
	_app->objectPresentationAddAnimationToPuzzle(kObject1033, 1, kPuzzle1020, "s00a01n08p01s01", kImageTypeBMP, Common::Point(140, 67), kDrawType1, 1000, 29, 12.5f, 16);
	...
	_app->objectAddPresentation(kObject1046);
	_app->objectPresentationAddAnimationToPuzzle(kObject1046, 1, kPuzzle1064, "s00a01n14p01s01", kImageTypeBMP, Common::Point(414, 119), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1050, 0, kPuzzle1030, "s00a01n03p04s01", kImageTypeBMP, Common::Point(175, 45), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1051, 0, kPuzzle1033, "s00a01n03p07s01", kImageTypeBMP, Common::Point(221, 77), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1053, 0, kPuzzle1027, "s00a01n03p01s01", kImageTypeBMP, Common::Point(161, 224), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(1053, 0, 0, 1001);
	_app->objectAddPresentation(kObject1053);
	_app->objectPresentationAddAnimationToPuzzle(kObject1053, 1, kPuzzle1027, "s00a01n03p01s02", kImageTypeBMP, Common::Point(366, 204), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1054, 0, kPuzzle1044, "s00a01n03p11s01", kImageTypeBMP, Common::Point(252, 98), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1054, 0, 0, 1001);
	_app->objectAddPresentation(kObject1054);
	_app->objectPresentationAddAnimationToPuzzle(kObject1054, 1, kPuzzle1044, "s00a01n03p11s02", kImageTypeBMP, Common::Point(392, 81), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1049, 0, kPuzzle1040, "s00a01n03p10s01", kImageTypeBMP, Common::Point(206, 43), kDrawType1, 1000, 28, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1057);
	_app->objectPresentationAddAnimationToPuzzle(kObject1057, 1, kPuzzle1045, "s00a04n03p05s01", kImageTypeBMP, Common::Point(379, 60), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1057, 1, 0, 1001);
	_app->objectAddPresentation(kObject1057);
	_app->objectPresentationAddAnimationToPuzzle(kObject1057, 2, kPuzzle1045, "s00a04n03p05s02", kImageTypeBMP, Common::Point(138, 17), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1059);
	_app->objectPresentationAddAnimationToPuzzle(kObject1059, 1, kPuzzle1046, "s00a04n06p01s01", kImageTypeBMP, Common::Point(388, 59), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1059, 1, 0, 1001);
	_app->objectAddPresentation(kObject1059);
	_app->objectPresentationAddAnimationToPuzzle(kObject1059, 2, kPuzzle1046, "s00a04n06p01s02", kImageTypeBMP, Common::Point(176, 35), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject10591);
	_app->objectPresentationAddAnimationToPuzzle(kObject10591, 1, kPuzzle1048, "s00a04n13p01s01", kImageTypeBMP, Common::Point(136, 19), kDrawType1, 1000, 29, 12.5f, 16);
	...
	_app->objectAddPresentation(kObject1062);
	_app->objectPresentationAddAnimationToPuzzle(kObject1062, 1, kPuzzle1051, "s00a04n03p03s01", kImageTypeBMP, Common::Point(45, 50), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1061);
	_app->objectPresentationAddAnimationToPuzzle(kObject1061, 2, kPuzzle1049, "s00a04n03p01s01", kImageTypeBMP, Common::Point(176, 57), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1061, 2, 0, 1001);
	_app->objectAddPresentation(kObject1061);
	_app->objectPresentationAddAnimationToPuzzle(kObject1061, 3, kPuzzle1049, "s00a04n03p01s02", kImageTypeBMP, Common::Point(485, 107), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1064, 0, kPuzzle1002, "s00a01n02p05s01", kImageTypeBMP, Common::Point(171, 26), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1064, 0, 0, 1001);
	_app->objectAddPresentation(kObject1064);
	_app->objectPresentationAddAnimationToPuzzle(kObject1064, 1, kPuzzle1002, "s00a01n02p05s02", kImageTypeBMP, Common::Point(315, 24), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1066, 0, kPuzzle1027, "s00a01n03p01s01", kImageTypeBMP, Common::Point(161, 224), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1066, 0, 0, 1001);
	_app->objectAddPresentation(kObject1066);
	_app->objectPresentationAddAnimationToPuzzle(kObject1066, 1, kPuzzle1027, "s00a01n03p01s02", kImageTypeBMP, Common::Point(366, 204), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1068);
	_app->objectPresentationAddAnimationToPuzzle(kObject1068, 1, kPuzzle1053, "s00a05n03p01s01", kImageTypeBMP, Common::Point(204, 91), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1068, 1, 0, 1001);
	_app->objectAddPresentation(kObject1068);
	_app->objectPresentationAddAnimationToPuzzle(kObject1068, 2, kPuzzle1053, "s00a05n03p01s02", kImageTypeBMP, Common::Point(321, 16), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1077);
	_app->objectPresentationAddAnimationToPuzzle(kObject1077, 1, kPuzzle1056, "s00a05n02p02s01", kImageTypeBMP, Common::Point(101, 59), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1077, 1, 0, 1001);
	_app->objectAddPresentation(kObject1077);
	_app->objectPresentationAddAnimationToPuzzle(kObject1077, 2, kPuzzle1056, "s00a05n02p02s02", kImageTypeBMP, Common::Point(396, 63), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject1081);
	_app->objectPresentationAddAnimationToPuzzle(kObject1081, 2, kPuzzle1060, "s00a01n02p06s01", kImageTypeBMP, Common::Point(436, 49), kDrawType1, 1000, 29, 12.5f, 4);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject1093, 0, kPuzzle1063, "s00a01n11p01s01", kImageTypeBMP, Common::Point(208, 22), kDrawType1, 1000, 29, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject1093, 0, 0, 1001);
	_app->objectAddPresentation(kObject1093);
	_app->objectPresentationAddAnimationToPuzzle(kObject1093, 1, kPuzzle1063, "s00a01n11p01s02", kImageTypeBMP, Common::Point(348, 101), kDrawType1, 1000, 29, 12.5f, 4);
...
void Zone1Pompeii::onButtonUp(ObjectId id, Id target, Id puzzleRotationId, uint32 a4, const Common::Point &point) {
	error("[Zone1Pompeii::onButtonUp] Not implemented");
}
