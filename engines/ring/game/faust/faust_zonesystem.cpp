...
void ZoneSystemFaust::onInit() {
	...
	_app->objectPresentationAddImageToPuzzle(kObjectQuestion, 0, kPuzzleMenu, "Question.tga", Common::Point(160, 165), true, kDrawType3, 1000);
	...
	_app->objectAddPresentation(kObjectQuestion);
	_app->objectPresentationAddImageToPuzzle(kObjectQuestion, 1, kPuzzleMenu, "box_yes.tga", Common::Point(291, 261), true, kDrawType3, 1000);
	_app->objectAddPresentation(kObjectQuestion);
	_app->objectPresentationAddImageToPuzzle(kObjectQuestion, 2, kPuzzleMenu, "box_no.tga", Common::Point(371, 261), true, kDrawType3, 1000);
