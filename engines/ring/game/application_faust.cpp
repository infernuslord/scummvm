...
void ApplicationFaust::initZone10() {
	...
	objectPresentationAddAnimationToPuzzle(kObject71002, 0, kPuzzle71002, "a07s01n11p01s01", kImageTypeBMP, Common::Point(164, 25), kDrawType1, 1000, 12, 12.5, 6);
	objectAddPresentation(kObject71002);
	objectPresentationAddAnimationToPuzzle(kObject71002, 1, kPuzzle71002, "a07s01n11p01s01", kImageTypeBMP, Common::Point(164, 25), kDrawType1, 1000, 12, 12.5, 10);
